        ...
        {isEditing ? (
          <div className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="fullName" className="block text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground ml-1">
                Full Name
              </label>
              <input
                id="fullName"
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="block text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground ml-1">
                Email Address
              </label>
              <input
                id="email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label htmlFor="phone" className="block text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground ml-1">
                  Phone Number
                </label>
                <input
                  id="phone"
              ...
              <div className="space-y-2">
                <label htmlFor="location" className="block text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground ml-1">
                  Location
                </label>
                <input
                  id="location"
            ...
            <div className="space-y-2">
              <label htmlFor="bio" className="block text-[10px] font-heading font-bold uppercase tracking-widest text-muted-foreground ml-1">
                Bio
              </label>
              <textarea
                id="bio"
