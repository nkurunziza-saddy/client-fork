      ...
      <div className="bg-background border-b border-border/40 py-3 md:py-4 px-3 sm:px-6 lg:px-8">
        <div className="max-w-[1800px] mx-auto flex items-center justify-between gap-4">
          ...
          <Badge
            ...
            className="shrink-0 rounded-none text-[8px] font-black uppercase tracking-[0.2em] px-2 py-1"
          >
            {statusLabel}
          </Badge>
        </div>
            ...
            <div className="space-y-6">
              ...
              {auction.company && (
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4 bg-muted/20 p-4 border border-border/40">
