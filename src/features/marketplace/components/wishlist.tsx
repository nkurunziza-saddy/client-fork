...
import type { Company, MarketplaceItem, Product, Service } from "@/types";
...
const Wishlist: React.FC<WishlistProps> = ({
  ...
  const handleToggleWishlist = (
    e: React.MouseEvent,
    item: Product | Service | Company,
  ) => {
    e.stopPropagation();
    // @ts-expect-error Types diverge
                    ...
                    <div className="p-5">
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {(item as { businessType?: string }).businessType && (
