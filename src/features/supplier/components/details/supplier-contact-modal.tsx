	...
	return (
		...
		>
			<div className="flex flex-col h-full max-h-[80vh]">
				<div className="p-4 sm:p-8 space-y-4 bg-background overflow-y-auto">
				...
				<div className="px-4 sm:px-8 pb-8 pt-4 bg-background space-y-3 mt-auto border-t border-border/10">
					<textarea
						value={message}
