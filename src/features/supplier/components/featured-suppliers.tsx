									...
									<div className="p-3.5 sm:p-6 flex flex-col h-full relative z-10">
										<div className="flex items-start justify-between mb-3 sm:mb-6">
											<div className="flex items-center gap-2.5 sm:gap-4 overflow-hidden">
												...
												<div className="flex flex-col min-w-0">
													<div className="flex items-center gap-1 sm:gap-2 mb-0.5 sm:mb-1">
														<h3 className="font-display font-black text-[11px] sm:text-xs md:text-sm text-foreground uppercase tracking-widest truncate group-hover:text-primary transition-colors leading-tight">
															{company.name}
														</h3>
														<RiShieldCheckLine
															size={10}
											...
											<div className="text-right shrink-0">
												<div className="flex items-center gap-1 text-primary justify-end mb-0.5 sm:mb-1">
													...
													/>
													<span className="text-[8px] sm:text-[10px] font-black font-display uppercase tracking-widest">
														{rating.toFixed(1)}
													</span>
												</div>
										...
										<div className="space-y-2.5 sm:space-y-4 mb-4 sm:mb-8">
											<div className="flex items-center gap-2">
												<div className="w-2.5 sm:w-4 h-[1px] bg-primary/40" />
												<p className="text-[7px] sm:text-[9px] font-black text-primary uppercase tracking-[0.3em] sm:tracking-[0.4em]">
