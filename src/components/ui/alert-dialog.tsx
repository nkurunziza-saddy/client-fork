...
function AlertDialogOverlay({
	...
	return (
		<AlertDialogPrimitive.Backdrop
			...
			className={cn(
				"data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 isolate z-50 bg-overlay/40 duration-100 supports-backdrop-filter:backdrop-blur-xs",
				className,
			)}
			{...props}
		/>
